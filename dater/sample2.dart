...
import 'month_picker.dart' as main;
...
class CalendarDatePicker extends StatefulWidget {
  ...
  CalendarDatePicker({
    ...
    this.initialCalendarMode = main.DatePickerMode.day,
  ...
  final main.DatePickerMode initialCalendarMode;
...
class _CalendarDatePickerState extends State<CalendarDatePicker> {
  ...
  late main.DatePickerMode _mode;
  ...
  void _handleModeChanged(main.DatePickerMode mode) {
    _vibrate();
    setState(() {
      _mode = mode;
  ...
  Widget _buildPicker() {
    switch (_mode) {
      ...
      case main.DatePickerMode.month:
        return Padding(
          padding: const EdgeInsets.only(top: _subHeaderHeight),
          child: main.MonthPicker(
            key: _yearPickerKey,
            currentDate: widget.currentDate,
            firstDate: widget.firstDate,
            lastDate: widget.lastDate,
          ...
          child: SizedBox(
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    _handleModeChanged(main.DatePickerMode.month);
                  },
                  child: Padding(
                ...
                GestureDetector(
                  onTap: () {
                    _handleModeChanged(main.DatePickerMode.year);
                  },
                  child: Padding(
                    padding: const EdgeInsets.symmetric(horizontal: 8),
                    child: Row(
                      children: <Widget>[
                        Text(
                          _localizations.formatYear(_currentDisplayedMonthDate),
                          overflow: TextOverflow.ellipsis,
                          style:
                              Theme.of(context).textTheme.subtitle2?.copyWith(
                                    color: Theme.of(context)
